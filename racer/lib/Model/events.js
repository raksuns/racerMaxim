...
Model.MUTATOR_EVENTS = {
	change: true, insert: true, remove: true, move: true, stringInsert: true, stringRemove: true, load: true, unload: true
};
...
Model.prototype.addListener = Model.prototype.on = function (type, pattern, cb) {
